...
___x_cmd_ghaction_init_x_cmd(){
    ...
    # eval "$(curl https://raw.githubusercontent.com/x-bash/get/dev/index.html 2>/dev/null)" 2>/dev/null || true
    eval "$(curl https://raw.githubusercontent.com/x-bash/get/dev/index.html)" || true
